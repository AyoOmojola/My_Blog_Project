...
class UpdateBlog(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self, **kwargs):
        return reverse_lazy('App_Blog:blog_details', kwargs={'blog_id':self.object.id})
...
class CreateBlog(LoginRequiredMixin,CreateView): # With this class method there is no need to use forms
    model = Blog
...
def blog_details(request,blog_id):
    blog = Blog.objects.get(pk=blog_id) # doing this to represent the id
